...
```
#Other comments: Your output files did load to my computer, which is good. However, some of them had no data, only headers. And the ones that did have data were not correctly sorted by position. 
#It looks like your positions sorted alphabetically, not numerically, probably because your "Position" column was in character form. 
